...
class Model(nn.Module):
    def __init__(self, num_embeddings, embedding_dim):
        ...
        self.text_tokenizer = transformers.AutoTokenizer.from_pretrained("microsoft/deberta-v3-base")
        self.text_encoder = transformers.AutoModel.from_pretrained("microsoft/deberta-v3-base")
